    ...
    return (
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
            <div className="card-body">
                <h2 style={{fontFamily:"aleo"}} className="text-center text-2xl text-black font-bold">Sign Up</h2>
                ...
                <p className='text-black text-center'><small>Already have an account? <Link className='text-primary' to="/login">Please login</Link></small></p>
